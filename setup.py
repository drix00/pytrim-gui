...
# Project modules.
from trim.gui import __author__, __email__, __version__, __copyright__, __project_name__
...
setup(
    ...
    description="TRansport of Ions in Matter (TRIM) GUI implemented in Python",
    long_description=long_description,
    keywords="ion python simulation modeling science physics GUI",
