...
.. |docs| image:: https://readthedocs.org/projects/pytrim-gui/badge/?version=latest
    :target: https://pytrim-gui.readthedocs.io/en/latest/?badge=latest
    :alt: Documentation Status

.. |travis| image:: https://travis-ci.org/pytrim/pytrim-gui.svg?branch=master
    :target: https://travis-ci.org/pytrim/pytrim-gui
    :alt: Travis-CI Build Status

.. |coveralls| image:: https://coveralls.io/repos/github/pytrim/pytrim-gui/badge.svg?branch=master
    :target: https://coveralls.io/github/pytrim/pytrim-gui?branch=master
